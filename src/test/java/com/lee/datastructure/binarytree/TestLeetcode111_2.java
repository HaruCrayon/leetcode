...
import com.lee.datastructure.binarytree.leetcode.Leetcode111_2;
import org.junit.jupiter.api.Test;

import static org.junit.jupiter.api.Assertions.assertEquals;

public class TestLeetcode111_2 {
    @Test
    public void test1() {
        TreeNode root = new TreeNode(new TreeNode(2), 1, new TreeNode(3));
        assertEquals(2, new Leetcode111_2().minDepth(root));
    }
    ...
    public void test3() {
        ...
        assertEquals(1, new Leetcode111_2().minDepth(root));
    }
